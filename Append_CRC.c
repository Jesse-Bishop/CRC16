 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Jun 13 00:55:56 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Append_CRC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Append_CRC_Outputs_wrapper(const uint16_T *index,
...
{
    const uint16_T   *index  = (const uint16_T*) ssGetInputPortSignal(S,0);
    const uint16_T   *value  = (const uint16_T*) ssGetInputPortSignal(S,1);
    int32_T        *message  = (int32_T *)ssGetOutputPortRealSignal(S,0);


    Append_CRC_Outputs_wrapper(index, value, message);
